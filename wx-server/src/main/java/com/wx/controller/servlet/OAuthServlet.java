package com.wx.controller.servlet;
...
//                    WxFactoryImpl.getInstance().getWxAppManager(appName).getOperator().getOauth2AccessToken(code);
...
//        if (openId == null)
//            return null;
//        WxManager wxAppManager = WxFactoryImpl.getInstance().getWxAppManager(appName);
...
//        WxMenuDao wxMenuDao = WxFactoryImpl.getInstance().getBean("wxMenuDao", WxMenuDao.class);
